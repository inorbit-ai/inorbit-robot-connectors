...
from inorbit_instock_connector.src.instock.config_instock import InstockConfig
...
class Connector:
    ...
    def __init__(self, robot_id: str, config: InorbitConnectorModel) -> None:
        ...
        # Threading for the main run functions
    ...
    def connect(self) -> None:
        ...
        The base function handles connecting to InOrbit based on the provided
        configuration. Subclasses should override this function to connect
        to any external services ensuring to call the super function as well.

        This function should not be called directly. Instead, call the
        start() method to start the connector. This ensures that the
        connector is only started once.
        """
    ...
    def start(self) -> None:
        ...
        This method should be called to start the execution loop of this
        connector. This method will block until the execution loop is
        started but run the loop on a new thread. This method will also call
        connect() to connect to any external services.
        """
    ...
    def disconnect(self) -> None:
        ...
        The base function handles disconnecting from InOrbit based on the
        provided configuration. Subclasses should override this function to
        disconnect from any external services ensuring to call the super
        function as well.

        This function should not be called directly. Instead, call the
        stop() method to stop the connector. This ensures that the
        connector is only stopped once.
        """
    ...
    def stop(self) -> None:
        ...
        This method should be called to stop the execution loop of this
        connector. This method will block until the execution loop is
        stopped. This method will also call disconnect() to clean up any
    ...
    def __run(self) -> None:
        """The main run thread function for the connector."""
    ...
    def execution_loop(self) -> None:
        ...
        execution loop for the connector. This method will be called
        repeatedly until the connector is stopped. This method should not be
        called directly. Instead, call the start() or stop() methods to start
        or stop the connector. This ensures that the connector is only
