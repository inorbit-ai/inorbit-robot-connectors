...
def get_robot_config(config_filename: str, robot_id: str) -> Dict[str, Any]:
    ...
    if robot_id not in full_config:
        available_robots = [key for key in full_config.keys() 
...
def _restructure_connector_config(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    mir_fields = [
        'mir_host_address', 'mir_host_port', 'mir_username', 'mir_password',
        'mir_api_version', 'mir_firmware_version', 'mir_use_ssl', 'verify_ssl',
        'ssl_ca_bundle', 'ssl_verify_hostname', 'enable_mission_tracking',
        'enable_temporary_mission_group', 'default_waypoint_mission_id'
    ]
...
def validate_config_structure(config_filename: str) -> Dict[str, Any]:
    ...
    if 'common' in full_config or 'fleet_defaults' in full_config:
        ...
        if 'robots' in full_config:
            ...
            validation['robots'] = [key for key in full_config.keys() 
